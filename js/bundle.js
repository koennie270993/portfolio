...
/* harmony export */   initScrollDepthTracking: () => (/* binding */ initScrollDepthTracking),
/* harmony export */   initializeEnhancedAnalytics: () => (/* binding */ initializeEnhancedAnalytics),
...
/* harmony export */   trackPortfolioItemView: () => (/* binding */ trackPortfolioItemView),
/* harmony export */   trackTimeOnPage: () => (/* binding */ trackTimeOnPage)
/* harmony export */ });
function trackButtonClick(button, category = 'Engagement') {
    try {
...
function trackPortfolioItemView(item) {
    try {
        let projectTitle = '';
...
function initializeEnhancedAnalytics() {
    try {
        ...
        document.querySelectorAll('a[href^="http"]').forEach(link => {
            link.addEventListener('click', function () {
                trackExternalLink(this);
            });
        });
        document.querySelectorAll('form').forEach(form => {
            form.addEventListener('submit', function () {
                trackFormSubmission(this, this.id || 'unnamed-form');
            });
        });
...
var cbpAnimatedHeader = (function () {
    ...
    function scrollPage() {
        ...
        if (sy >= changeHeaderOn) {
            _classie__WEBPACK_IMPORTED_MODULE_0__.classie.add(header, 'navbar-shrink');
        }
        else {
            _classie__WEBPACK_IMPORTED_MODULE_0__.classie.remove(header, 'navbar-shrink');
        }
        didScroll = false;
    }
    function scrollY() {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (cbpAnimatedHeader);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _lib_jquery_ready__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./lib/jquery-ready */ "./src/lib/jquery-ready.ts");

(0,_lib_jquery_ready__WEBPACK_IMPORTED_MODULE_0__.jQueryReady)(($) => {
...
/* harmony import */ var _dark_mode__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./dark-mode */ "./src/dark-mode.ts");
...
/* harmony import */ var _image_swap__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./image-swap */ "./src/image-swap.ts");
/* harmony import */ var _image_swap__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(_image_swap__WEBPACK_IMPORTED_MODULE_5__);
/* harmony import */ var _freelancer__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./freelancer */ "./src/freelancer.ts");
/* harmony import */ var _contact_me__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./contact_me */ "./src/contact_me.ts");
/* harmony import */ var _contact_me_static__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./contact_me_static */ "./src/contact_me_static.ts");
/* harmony import */ var _analytics_enhanced__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./analytics-enhanced */ "./src/analytics-enhanced.ts");
/* harmony import */ var _video_player__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./video-player */ "./src/video-player.ts");
